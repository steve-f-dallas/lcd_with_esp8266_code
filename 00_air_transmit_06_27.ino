/*----------------------------------------------------------------------------------------------------
  Project Name : Air term transmit
...
void setup()
{
  ...
  if (MQTT) {
    ...
    client.publish("home/pool/airtemp/tempc", _PoolTemp, 1);         // ,1 = retained
    delay(50);
    client.publish("home/debug", "PoolMonitor: Just published pool temp to home/pool/airtemp/tempc");  
    delay(50); 
    ...
    client.publish("home/pool/airtemp/battv", _batteryVoltage, 1);   // ,1 = retained
    delay(50);
    client.publish("home/debug", "PoolMonitor: Just published batt voltage to home/pool/airtemp/battv");
    delay(50);
    Serial.print("Time of last transmission...");
    Serial.println(actualtime);
    client.publish("home/pool/airtemp/lastupdate", actualtime, 1);   // ,1 = retained
    client.publish("home/debug", "PoolMonitor: Just published lastupdate to home/pool/airtemp/lastupdate");
    delay(50);
  ...
  Blynk.virtualWrite(8, PoolTemp);           // virtual pin 11
  Blynk.virtualWrite(9, batteryVoltage);     // virtual pin 12
  Blynk.virtualWrite(10, actualtime);         // virtual pin 13
...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    String clientId = "Wemos-D1-Micro-";
