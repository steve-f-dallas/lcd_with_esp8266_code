...
// Publish an MQTT message on topic esp32/temperature with Fahrenheit temperature readings
     
    client.publish("esp32/temperature",_PoolTemp, 1);
    client.publish("esp32/temperature",_batteryVoltage, 1);
    client.publish("esp32/temperature",actualtime, 1);
