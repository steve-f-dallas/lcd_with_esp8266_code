...
char auth[] = "yazrTQObdVHbNDMYbRtZFG5cazSMW1wd"; // Blynk Auth Token

char ssid[] = "Steves";                           // WiFi Router ssid
char pass[] = "sef-1969-CHERYL-1216";             // WiFi Router password

const boolean MQTT = true;                        // Set this to false if you are not using MQTT

const char* mqtt_server = "192.168.1.88";       // MQTT Server address, leave blank if your are not using MQTT


/****** Additional Settings **************************************************/

const boolean is_metric = false;                   // Set this to true for Celcius, false for Fahrenheit
